 ...
 * displays the output of a negitive number "-100".
 * @author David Anderson
 */
public class FibNeg100Test extends TestCase{
  ...
  // Test that using Fibonacci -100 produces the correct output of
  // 1.
  // This is due to it being outside the correct bounds.
  @Test
  public void testFibNeg100() throws Exception {
    driver.get(baseUrl + "/");
