...
/**
 * As a user,
 * I would like to see if the navigation on the Fibonacci page
 ...
 *
 */
public class FibNavLinkTEst extends TestCase{
  ...
  // Test to see that all the navigation links on the Fibonacci page 
  // are correctly linked to the correct pages.
  @Test
