 ...
 * displays the output of the a string "jester".
...
public class FibStringTest extends TestCase {
  ...
  // Test that using Fibonacci string "jester" produces the correct output of
  // 1.
  ...
  public void testFibString() throws Exception {
    ...
    driver.findElement(By.id("tb1")).sendKeys("jester");
